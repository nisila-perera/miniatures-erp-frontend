...
export default function EditProductPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // Check if product is from WooCommerce (read-only)
        if (productData.source === ProductSource.WOOCOMMERCE) {
        ...
        setFormData({
          ...
          is_colored: productData.is_colored,
  ...
  const handleChange = (field: keyof ProductUpdate, value: string | number | boolean) => {
