...
import { createResin } from '@/services/inventory';
...
export default function NewResinPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitError(err instanceof Error ? err.message : 'Failed to create resin');
    } finally {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Add a new resin entry to inventory
            </p>
          </div>
        </div>
